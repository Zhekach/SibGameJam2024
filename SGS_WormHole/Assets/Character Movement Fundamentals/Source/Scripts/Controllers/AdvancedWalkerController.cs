...
namespace CMF
{
    ...
    public class AdvancedWalkerController : Controller
    {
        ...
        private float _platformSecondsLife;

        private Transform _playerRotationTransform;
        ...
        {
            return currentControllerState == ControllerState.Falling;
        }
        ...
        protected virtual bool IsCreatePlatformKeyPressed()
        {
            ...
            return characterInput.IsCreatePlatformKeyPressed();
        }
